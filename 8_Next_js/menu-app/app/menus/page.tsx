 ...
 /*
    #2. fetch
     ...
     - fetch함수에 cache속성을 추가하지 않는 경우 cache:auto속성이 적용된다. 
       cahe:auto는 기본 static render방식으로 페이지를 서비스한다. 
    ...
    2) cache : no-store
     ...
     - 옵션 미지정시 기본값으로 사용되는 경우가 있다. 
        = fetch에서 ckkoies, headers, searchParams..등을 사용하는 경우
 ...
 */
  ...
  const initalMenus:Menu[] = await loadMenus();
  ...
  return(
    <div className="menu-container">
      ...
      <MenuListClient initalMenus={initalMenus} />
    </div>
  )
}
