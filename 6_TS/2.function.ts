...
/*
    7. 타입 좁히기(Type narrowing)
     ...
     있을 때, 이를 사용하는 시점에서 특징 한가지로 좁히는 문법
...
// not null 단언문
// - 선택한 변수의 값이 null(usndefined포함)이
//   아님을 단언하는 문법
...
/*
    9. never type
     ...
     반환할 수 없는 함수나, 도착할 수 없는 코드블럭을 표현할때
     사용
     - never는 예외적인 상왛을 명확히 표현하여 버그를 방지하기
     위해 사용한다.
*/
...
function typeNarrowing2(sOrn:etc):void{
    ...
    throw new Error('허용하지 않는 자료형입니다')
}
const any:any = ['11'];
typeNarrowing2(any);
