...
import OptimizationKook from './02_react_advanced/02_OptimizationHook'
...
import Header from './02_react_advanced/05_Routing'
  ...
  return (
    <>
          ...
          <div>
            ...
            {/* 
             Link 
              ...
              컴포넌트를 전환한다. 
              - a태그로 인한 페이지 이동은 locatuon을 조작하는 행위로, 리액트에서는 
              권장되지 않는 이동방식이다. 
      ...
      <nav className='nav'>
          ...
          <li>
            <Link to="/poketmon">Poketmon</Link>
          </li>
        </nav>
    </>
  )
